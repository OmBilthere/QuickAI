...
const BlogTitles = () => {
   ...
   const blogCategories = ['General' , 'Technology' , 'Business' , 'Health' , 'Lifestyle' , 'Travel' , 'Education' , 'Entertainment' , 'Food' ] 
    ...
    const onSubmitHandler = async (e) => {
      ...
      try {
        setLoading(true);
        const prompt = `Generate exactly 10 catchy and engaging blog titles about ${input} in the ${selectedCategory} category. Return only a numbered list from 1 to 10 with titles only.`
