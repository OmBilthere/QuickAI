...
const GenerateImage = () => {
     ...
     const imageStyle = ['Realistic' , 'Ghibli Style' , 'Cartoon' , 'Anime' , 'Fantasy' , 'Realistic Style' , '3D Style' , 'Portrait' ] 
      ...
      const onSubmitHandler = async (e) => {
        ...
        try {
          setLoading(true);
          const prompt = `Generate a ${selectedStyle} image based on the following description: ${input}. The image should be visually appealing and accurately represent the description provided.`
  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
         ...
         rounded-md border border-gray-300' placeholder='Describe the image you want to generate...' required />
       ...
       text-sm rounded-lg cursor-pointer'>
        ...
        {
          loading ? <span className='w-4 h-4 my-1 rounded-full border-2 border-white border-t-transparent animate-spin'></span> : <Image className='w-5' />
        }
