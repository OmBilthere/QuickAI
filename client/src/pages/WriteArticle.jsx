...
const WriteArticle = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      const prompt = `Write an article about ${input} in ${selectedLength.length} words. Make sure the article is well-structured, engaging, and informative.`
  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
       ...
       text-sm rounded-lg cursor-pointer' type='submit'>
        {
