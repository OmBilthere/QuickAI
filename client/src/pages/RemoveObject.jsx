...
const RemoveObject = () => {
    ...
    const [input , setInput] = useState(null)
     ...
     const onSubmitHandler = async (e) => {
          ...
          if (!input || !object || object.trim() === '') {
            toast.error('Please select an image and describe the object to remove.');
            return;
          }
  ...
  return (
    ...
    text-slate-700'>
      ...
      border-gray-200'>
         ...
         rounded-md border border-gray-300' placeholder='e.g., a person, a car, or an object' required />
     

       <button disabled={loading} className='w-full flex justify-center items-center gap-2
       bg-linear-to-r from-[#4A7AFF] to-[#8E37EB] text-white px-4 py-2 mt-6
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96'>
          ...
          <div className='flex-1 flex justify-center items-center'>
            ...
            <img src={content} alt="Processed" className='mt-3 h-full w-full' />
          )
